	...
	function openViewer(visitId, url, title, text) {
		...
		if(!mm){ 
			...
			new Element('div',{ 
				...
				style:'padding:20px; width:720px; max-width:95%; max-height:80%; border-radius:6px; box-shadow:0 8px 24px rgba(0,0,0,0.2); margin:0 auto; overflow-y:auto;' , 
